let app = new Vue({
    ...
    methods: {
        ...
        getFieldsInfo: function() { // 获取已有字段信息
            ...
            $.ajax({
                type: "GET",
                url: "/tableOnline/root/getAllKeys",
                dataType: "json",
                success: function (res) {
                    if(res.code === 200){
        ...
        handleEditForm: function() {
            ...
            this.$confirm('即将提交，是否选择了发布条件?', '提示', {
                ...
                $.ajax({
                    ...
                    url: "/tableOnline/root/createForm",
                    ...
                    success: function (res) {
                        if(res.code === 200){
                            ...
                            setTimeout(() => location.href = "/tableOnline/pages/root/formList.html", 1500);
                        }else{
